...
No software[^not-all-software] is free from technical debt.
...
One of core responsibilities of software engineers is to control the marginal cost[^marginal-cost] of:

- Extending a system with new functionality
- Scaling a system for broader use

This helps keep the cost of change low over time.[^cost-of-change]
...
[^not-all-software]: Aside from ephemeral software that is discarded after use.

[^marginal-cost]: Marginal cost, by definition, is the change in the total cost when the quantity produced is increased.
...
[^cost-of-change]: Keeping marginal costs low was one of the claimed benefits of [Extreme Programming (XP)](https://en.wikipedia.org/wiki/Extreme_programming); a set of practices that predated Agile.
