...
In the past, I’ve used tools like [Hemingway Editor][4], [Grammarly][5], and the style filters in [iA Writer][6] to trim back my prose so it is more digestible and readable.
In response to the bland, characterless, [AI-generated slop][7] that has become ubiquitous across the Internet, I have intentionally shifted the timbre of my writing to track _more closely_ to my personal voice.
...
[^4]: If I were as prolific and as authoritative as someone like [Gwern][10], LLMs might even know who I was without looking me up first—an odd kind of fame.
