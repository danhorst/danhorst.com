...
- Weeks are the most useful unit of time.[^1] Months are too long to go without a recap. Days are too short to identify any trends. The _week number_ helps anchor it in context; I track two:
	- The current year e.g. 2024 WK 45
	    ...
	    - You can configure the [Periodic Notes plugin][2] for [Obsidian][3] to create weekly notes using this format by setting the Format for Weekly Notes to `YYYY/MM/YYYY [WK]ww`.
	- The week of my life e.g. 2167 (of [about 4000][4]). I was born on a Friday so I increment my "death clock" week number at the end of the workweek.
...
[2]: https://github.com/liamcain/obsidian-periodic-notes
[3]: https://obsidian.md/
[4]: https://www.oliverburkeman.com/fourthousandweeks
