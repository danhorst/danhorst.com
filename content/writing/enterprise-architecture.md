...
Let's break this down a bit. First, a "service" is any function that supports a business need for an organization. Any software used by an organization can be classified as a service be it vended solutions, custom applications, databases, or (god forbid) spreadsheets full of pivot tables. How these services are managed and operated falls under the purview of these two acronyms:
